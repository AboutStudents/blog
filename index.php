...
/*
  Created By Amir Mohammad Zare
*/

// Site name
const SITENAME = 'zareonit';

// Description (optional)
const SITEDESC = 'وبلاگ امیر محمد زارع';

// Username
const USERNAME = 'Amirmohammadzare';
...
// Language strings
const L_SEARCH = 'جستوجو';
const L_PLACEHOLDER = 'شروع نوشتن &hellip;';
const L_POSTCONTENT = 'پست محتوا';
const L_PUBLISH = 'ارسال';
const L_LOGOUT = 'خروج';
const L_EDIT = 'ویرایش';
const L_DELETE = 'حذف';
const L_OLDER = 'پیشکسوت';
const L_NEWER = 'تازه';
const L_USERNAME = 'نام کاربری';
const L_PASSPHRASE = 'Passphrase';
const L_LOGIN = 'ورود';
const L_BACK = 'برگشت';
const L_ERROR = 'ارور';
const L_ERROR_LOGIN = 'داده ها درست نیستند.';
const L_ERROR_EMPTY = 'پست شما نباید خالی باشد.';
const L_ERROR_POSTEXISTS = 'یک پست با این ای دی از قبل وجود دارد.';
const L_ERROR_POSTNONEXISTENT = 'پستی که شما میخواهید ادیت کنید نباید خالی باشد.';
const L_ERROR_NORESULTS = 'نتایجی برای جستوجوی شما وجود ندارد';
const L_ERROR_HACKER = 'تلاش خوبی بود.';
